...
public class MainActivity extends AppCompatActivity {
    ...
    //To open a dialog box where user will enter sign in details
    ...
    public void processRequest() {
        // Configure Google Sign In...Creating a request which will be passed to google
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 101) {
            ...
            try {
                // Google Sign In was successful, all details will be store in this GoogleSigInObject

                GoogleSignInAccount account = task.getResult(ApiException.class);
                Log.d(TAG, "onActivityResult: Some error");
